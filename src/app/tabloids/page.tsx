    ...
    <>
      <div className="flex relative flex-col  w-auto h-auto ">
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 11
          <iframe
            src="https://drive.google.com/file/d/1veba6c-gUBntMdCxoOeiTsQ42G1lEHWD/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 10
          <iframe
            src="https://drive.google.com/file/d/1aGkUuleaTzujKY6XwoL8HLLfVJCCZNaN/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 9
          <iframe
            src="https://drive.google.com/file/d/19R0ctZ-LhKZ1IeKrukeoh3UW41v-C6wK/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 7
          <iframe
            src="https://drive.google.com/file/d/10qmuUj5wjXc9hNwl2Ufti8ciPN61DRIt/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 6
          <iframe
            src="https://drive.google.com/file/d/1-bYArvJOkEIDpdXsiBNy0ytExBORAUIM/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 5
          <iframe
            src="https://drive.google.com/file/d/1mmXAH5GmZJ60P51dOtugnjmQMdJr5DyC/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 4
          <iframe
            src="https://drive.google.com/file/d/1Vb8aXIpXgdVlFrBL_q6u9_JvVlHvLQeq/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 3
          <iframe
            src="https://drive.google.com/file/d/1mYZm3aN7f4wc3a4kI4g0Ku8sTEsFewog/preview"
            width="100% "
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10  items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 2
          <iframe
            src="https://drive.google.com/file/d/1aUrkYqHeodrx9MrnjpaKqQSf1o9f_JxV/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
        ...
        <div className="flex flex-col justify-center mb-16 md:mx-10 items-center text-zinc-700 text-2xl md:text-3xl font-semibold font-mono border border-black border-solid  ">
          Tabloid Issue 1
          <iframe
            src="https://drive.google.com/file/d/1bh226035gJwsREEfF0BddWCdfajhsd-F/preview"
            width="100%"
            height="600"
            allow="autoplay"
          ></iframe>
