                ...
                <form className='mt-4' onSubmit={handleSubmit(onSubmit)}>
...

                    {
                        isSubmitted ?
                            ...
                            <button type="button" onClick={refreshPage} className={poppins.className +" relative bg-transparent py-1 px-1 rounded-md text-purple-700 overflow-hidden font-medium border-purple-500 hover:border-green-600 shadow-inner group"}>
