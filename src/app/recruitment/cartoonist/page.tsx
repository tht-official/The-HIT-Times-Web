    ...
    <div className="min-h-screen bg-gray-200">
      <div className="max-w-3xl mx-auto">
        ...
        <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormInput
            title="What are your favourite cartoon/anime series or comic strips?"
            id="Q1_cartoon"
            isRequired={true}
            register={register}
          />
          ...
          <FormInput
            title="What is your opinion on the Graph Theory portion of The HIT Times?"
            id="Q2_cartoon"
            isRequired={false}
            register={register}
          />
          ...
          <FormInput
            title="How would you suggest we introduce more caricatures or cartoons in the paper going forward?"
            id="Q3_cartoon"
            isRequired={false}
            register={register}
          />
          ...
          <FormInput
            title="Why do you like making art?"
            id="Q4_cartoon"
            isRequired={false}
            register={register}
          />
          ...
          <FormInput
            title="Do you like Cartooning or Doodling? "
            id="Q5_cartoon"
            isRequired={false}
            register={register}
          />
