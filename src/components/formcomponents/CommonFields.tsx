    ...
    <div>
        <div className='flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg mb-4'>
                        ...
                        <div className="py-5 px-6 lg:px-8 flex flex-col">
                            <label htmlFor="dept" className={poppins.className + " text-white text-md mb-4"}>
                                Department
                            ...
                            <div className='flex flex-row mb-3 text-slate-300'>
                    ...
                    <div className='flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg mb-4'>
                        {/* <div className='bg-blue-400 w-0.5 lg:w-1 rounded-l-3xl'></div> */}
                        <div className="py-5 px-6 lg:px-8 flex flex-col">
                            <label htmlFor="year" className={poppins.className + " text-white text-md mb-1"}>
                                Year
                                <span className='text-md text-red-600 pl-1'>*</span>
                            </label>
                            <p className={poppins.className + " text-slate-100 text-sm mb-4"}>
                    ...
                    <div className='flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg mb-4'>
                        ...
                        <div className="py-5 px-4 sm:px-6 lg:px-8 flex flex-col">
                            <label htmlFor="phone" className={poppins.className + " text-white text-md mb-2"}>
                                Contact Number
                                <span className='text-md text-red-600 pl-1'>*</span>
                            </label>
                            ...
                            <input className='border-b border-gray-300 bg-transparent text-white focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400' placeholder="Short answer text" type='text' id="phone" required {...register("phone")} />
                        </div>
                    </div>

                    <div className='flex flex-row bg-white  bg-opacity-15 shadow-md rounded-lg my-4'>
                        {/* <div className='bg-blue-400 w-0.5 lg:w-1 rounded-l-3xl'></div> */}
                        <div className="py-5 px-4 sm:px-6 lg:px-8 flex flex-col">
                            <label htmlFor="email" className={poppins.className + " text-white text-md mb-2"}>
                                Email
                                <span className='text-md text-red-600 pl-1'>*</span>
                            </label>
                            <input className='border-b border-gray-300 bg-transparent text-white focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400' placeholder="Short answer text" type='text' id="email" required {...register("email")} />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg my-4'>
                        {/* <div className='bg-blue-400 w-0.5 lg:w-1 rounded-l-3xl'></div> */}
                        <div className="py-5 px-4 sm:px-6 lg:px-8 flex flex-col">
                            <p className={poppins.className + " text-white text-md mb-3"}>
                                What are your hobbies?
                                <span className='text-md text-red-600 pl-1'>*</span>
                            </p>
                            <input className='border-b border-gray-300 bg-transparent text-white focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400' placeholder="Short answer text" type='text' id="hobbies" required {...register("hobbies")} />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg my-4'>
                        ...
                        <div className="py-5 px-4 sm:px-6 lg:px-8 flex flex-col">
                            ...
                            <input className='border-b border-gray-300  bg-transparent text-white focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400' placeholder="Long answer text" type='text' id="qualities" {...register("qualities")} />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg my-4'>
                        ...
                        <div className="py-5 px-4 sm:px-6 lg:px-8 flex flex-col">
                            ...
                            <input className='border-b border-gray-300 bg-transparent text-white focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400' placeholder="Long answer text" type='text' id="ragging_opinion" required {...register("ragging_opinion")} />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-row bg-white bg-opacity-15 shadow-md rounded-lg my-4'>
                        ...
                        <div className="py-5 px-4 sm:px-6 lg:px-8 flex flex-col">
                            ...
                            <input className='border-b border-gray-300 bg-transparent text-white focus:outline-none focus:border-purple-600 focus:border-b-2 py-1 focus:placeholder-purple-400' placeholder="Long answer text" type='text' id="why_join_THT" required {...register("why_join_THT")} />
                        </div>
                    </div>
