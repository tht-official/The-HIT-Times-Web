...
const highlightedGroups: Record<string, HighlightGroup> = {
  ...
  group2: { days: [9], dotClass: "bg-[#2e6900] dark:bg-[#3d8f00] border-2 border-[#1a4500] dark:border-[#55ff55]", labelClass: "text-[#2e6900] dark:text-[#55ff55]", description: "Photowalk" },
  group3: { days: [2,8],    dotClass: "bg-[#006e8c] dark:bg-[#007fa3] border-2 border-[#003d4d] dark:border-[#55ffff]", labelClass: "text-[#006e8c] dark:text-[#55ffff]", description: "Offline Training" },
};
