...
const highlightedGroups: Record<string, HighlightGroup> = {
  ...
  group2: { days: [4, 5, 6], dotClass: "bg-[#2e6900] dark:bg-[#3d8f00] border-2 border-[#1a4500] dark:border-[#55ff55]", labelClass: "text-[#2e6900] dark:text-[#55ff55]", description: "Online Training" },
...
const digitalArtCalendar: React.FC = () => {
  return (
    <BaseCalendar
      month={7}
      year={2026}
      title="TSP · Digital Art"
      highlightedGroups={highlightedGroups}
    />
  );
};

export default digitalArtCalendar;
